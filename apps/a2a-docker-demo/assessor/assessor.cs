...
bld.Services
   ...
   .AddA2A(o =>
   {
       o.AgentName = "fe-assessor-agent";
       o.Description = "Assessor specialist agent - assigns priority level based on classification.";
       o.Version = "1.0.0";
...
sealed class AssessorSkillEndpoint : Endpoint<AssessorRequest, AssessorResponse>
{
    public override void Configure()
    {
        ...
        this.A2ASkill(
            ...
            {
                skill.Name = "Assessor";
                skill.Description = "Assigns priority level based on classification and urgency. Determines which handler should process the request.";
                skill.Examples = ["Assess priority for critical technical issue"];
