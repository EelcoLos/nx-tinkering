...
{
    public string ServiceName { get; set; } = "handler";
    public int Port { get; set; } = 5055;
    public string ServiceBaseUrl { get; set; } = "http://handler:5055";
    ...
    public string AgentId { get; set; } = "handler-agent";
    ...
    {
        options.ServiceBaseUrl = Environment.GetEnvironmentVariable("HANDLER_SERVICE_URL") ?? options.ServiceBaseUrl;
        ...
        options.AgentId = Environment.GetEnvironmentVariable("HANDLER_AGENT_ID") ?? options.AgentId;
