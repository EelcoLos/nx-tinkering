...
class ServiceRegistrar
{
    ...
    public async Task RegisterAsync()
    {
        ...
        var registration = new ServiceRegistrationRequest
        {
            ...
            Port = _settings.Port,
            Description = "A2A specialist that processes routed requests.",
            Skills = new List<string> { "request-handling" },
            AgentCard = new AgentCard
            {
                ...
                {
                    new AgentSkill { Id = "request-handling", Name = "request-handling", Description = "Processes a routed request and returns the outcome." }
                }
            }
        };
...
class SkillEndpoint : Endpoint<HandleRequest, HandleResponse>
{
...
var response = new HandleResponse
{
    Status = "processed",
    TicketId = ticketId,
    Summary = $"Handled {classification} request with {priority} priority."
};
