...
class ServiceRegistrar
{
    ...
    public async Task RegisterAsync()
    {
        ...
        var registration = new ServiceRegistrationRequest
        {
            ...
            Port = _settings.Port,
            Description = "A2A specialist that classifies incoming text.",
            Skills = new List<string> { "classification" },
            AgentCard = new AgentCard
            {
                ...
                {
                    new AgentSkill { Id = "classification", Name = "classification", Description = "Classifies incoming text into a triage category." }
                }
            }
        };
...
class SkillEndpoint : Endpoint<ClassifyRequest, ClassifyResponse>
{
...
var response = new ClassifyResponse
{
    ...
    Result = $"Input classified as {classification}."
};
