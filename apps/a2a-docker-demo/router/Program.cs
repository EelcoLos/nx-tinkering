...
class ServiceRegistrar
{
    ...
    public async Task RegisterAsync()
    {
        ...
        var registration = new ServiceRegistrationRequest
        {
            ...
            Port = _settings.Port,
            Description = "A2A specialist that routes work based on priority.",
            Skills = new List<string> { "routing" },
            AgentCard = new AgentCard
            {
                ...
                {
                    new AgentSkill { Id = "routing", Name = "routing", Description = "Determines the next handler for a given priority." }
                }
            }
        };
...
class SkillEndpoint : Endpoint<RouteRequest, RouteResponse>
{
...
var response = new RouteResponse
{
    ...
    Result = $"Priority {priority} routed to {nextHandler}."
};
