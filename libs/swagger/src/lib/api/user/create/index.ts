...
// @ts-ignore
import { createMyResponseFromDiscriminatorValue, serializeMyRequest, serializeMyResponse, type MyRequest, type MyResponse } from '../../../models/index.js';
// @ts-ignore
...
export interface CreateRequestBuilder extends BaseRequestBuilder<CreateRequestBuilder> {
     ...
     */
     post(body: MyRequest, requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<MyResponse | undefined>;
    /**
     * @param body The request body
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     * @returns {RequestInformation}
     */
     toPostRequestInformation(body: MyRequest, requestConfiguration?: RequestConfiguration<object> | undefined) : RequestInformation;
}
/**
