...
export function createMyTsClient(requestAdapter: RequestAdapter) {
  ...
  return apiClientProxifier<MyTsClient>(
    requestAdapter,
    pathParameters,
    MyTsClientNavigationMetadata,
    undefined,
  );
}
/**
 ...
 */
export const MyTsClientNavigationMetadata: Record<
  Exclude<keyof MyTsClient, KeysToExcludeForNavigationMetadata>,
  NavigationMetadata
> = {
  api: {
